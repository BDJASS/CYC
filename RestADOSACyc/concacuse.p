...
PROCEDURE PostGeneraAcuse:
    ...
    DO:
        ...
        END.
        ELSE DO:  // Entra si no detecta Santander
             l-FecDep = ttPago.FecDep. // en App Manual pueden modificar Fecha
        END.
    END.
    ELSE 
    DO:
        FIND FIRST ttPago WHERE ttPago.FecDep <> ? NO-LOCK NO-ERROR. 
        IF AVAILABLE ttPago THEN l-FecDep = ttPago.FecDep.
    END.
