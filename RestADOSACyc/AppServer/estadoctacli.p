...
DEFINE TEMP-TABLE ttOrdenCompra
    ...
    FIELD DiasVencido2 AS CHARACTER
...
//                END.
            ...
            DO:
                ...
                DO:
                    ...
                    */
                    ...
                    IF MovCliente.Id-MC = 2 THEN
                        ASSIGN ttDatos.TotDevNCR = ttDatos.TotDevNCR + l-saldo. 
                END.
                ...
                DO:
                    ...
                    DO:
                        ASSIGN
                            l-temporada         = IF Factura.Id-Cond = 1 THEN "S"
                                  ELSE IF Factura.Id-Cond = 4 THEN "E"
                                  ELSE IF Factura.Id-Cond = 5 THEN "N"
                                  ELSE ""
                        ...
                        DO:
                            ...
                            DO:
                                ...
                                DO:
                                    ...
                                    IF ipFecha > ttOrdenCompra.FecVenc2 THEN
                                        ttOrdenCompra.DiasVencido2 = STRING(INTEGER(ipFecha - ttOrdenCompra.FecVenc2)).
                                    ELSE
                                        ttOrdenCompra.DiasVencido2 = "".       
                                END.  
                            END. /* JASS23062025 */
                        END.
